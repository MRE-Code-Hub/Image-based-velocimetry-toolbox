...
The Farnebäck algorithm may be used to detect turbulent motion, as shown for synthetic image sequences in Bung and Valero (2017, [handle](http://hdl.handle.net/2268/214198)). In contrast, real air-water flow sequences are subject to image noise and a validation of turbulent fluctuations needs to be established. At the moment, little is known about the performance of OF techniques in unsteady air-water flows. 
