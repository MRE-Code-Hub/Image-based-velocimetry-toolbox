...
- Image pyramid level: The algorithms allows computation of subsampled frames, were the resolution is decreasing with increasing pyramid level. The results were independent of the image pyramid level, which may not hold true for all applications, compare Bung 
- Sampling frequency
- Sampling duration
- Gradient threshold
