...
The Farnebäck algorithm may be used to detect turbulent motion, as shown for synthetic images in Bung and Valero (2017, [handle](http://hdl.handle.net/2268/214198)). However, a thorough validation of turbulent fluctuations needs to be established for real air-water flow sequences, especially as they are subject to image noise. At the moment, little is known about the performance of OF techniques in unsteady air-water flows. 
