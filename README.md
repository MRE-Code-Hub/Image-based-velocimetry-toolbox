...
- Sampling frequency: Based on the sensitivity analysis, a sampling rate of at least 2,000 fps or better 5,000 fps is recommended, which is in accordance with an earlier study of Zhang and Chanson ([DOI]https://doi.org/10.1016/j.expthermflusci.2017.09.010)).
- Sampling duration
- Gradient threshold
